export default class {
    ...
    resize(sx, sy) {
        ...
        this.ctx.drawImage(
            ...
            oldWidth,
            oldWidth,
            sx * oldWidth + (oldWidth - newWidth) / 2,
            sy * oldWidth + (oldWidth - newWidth) / 2,
            newWidth,
            newWidth
        );
    }
    ...
    renderMove() {
        ...
        switch (this.move.type) {
            case "move":
                this.ctx.strokeStyle = "#99ff33";
                break;
            case "take":
                this.ctx.strokeStyle = "#ff6633";
                break;
            case "promotion":
                this.ctx.strokeStyle = "#8616ab";
                break;
        }
        ...
        this.ctx.moveTo(
            ...
            this.canvas.height -
                this.move.start[1] * this.pieceSize -
                this.pieceSize / 2
        );
        this.ctx.lineTo(
            this.move.end[0] * this.pieceSize + this.pieceSize / 2,
            this.canvas.height -
                this.move.end[1] * this.pieceSize -
                this.pieceSize / 2
        );
        this.ctx.stroke();
    }
